  ...
  if (isSuperAdmin) {
    ...
    return (
      <div className="p-6 bg-gray-50 min-h-screen">
        ...
        {/* Métricas Principales - SIN PEDIDOS */}
        <Grid container spacing={3} className="mb-6">
          ...
          <Grid item xs={12} sm={6} md={4}>
            <MetricCard
              ...
              subtitle={`${resumenGeneral.ventasMes.cantidad} ventas completadas`}
              icon={AttachMoney}
              color="green"
            />
          </Grid>
                ...
                {top5Productos.length > 0 ? (
                  top5Productos.map((producto, index) => (
                    <Box
                      ...
                      className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-white rounded-lg hover:shadow-md transition-shadow border border-gray-100"
                    >
                      <Box className="flex items-center gap-3 flex-1 min-w-0">
                        <Box className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center font-bold text-white shadow-md flex-shrink-0">
                          {index + 1}
                        </Box>
                      ...
                      <Chip
                        label={`${producto.cantidadVendida || 0}`}
                        size="small"
          ...
          <Paper className="p-4 rounded-xl shadow-lg mb-6" elevation={3}>
            <Box className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
              <Box>
                <Typography variant="h6" className="font-bold">
                  Rendimiento de Tiendas (Este Mes)
                </Typography>
              </Box>
              <Chip
            ...
            <Grid container spacing={2} className="mb-6">
              <Grid item xs={12} sm={6} md={3}>
                <Box className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
                  <Typography
                    variant="caption"
                  ...
                  <Typography
                    variant="h5"
                    className="font-bold text-green-700 mt-1"
                  >
                    {formatCurrency(
                      ventasPorTienda.reduce((sum, t) => sum + t.totalVentas, 0)
                    )}
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} sm={6} md={3}>
                <Box className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
                  <Typography
                    variant="caption"
                    className="text-gray-700 font-medium"
                  >
                  ...
                  <Typography
                    variant="h5"
                    className="font-bold text-blue-700 mt-1"
                  >
                    {formatCurrency(
                      ventasPorTienda.reduce(
                        (sum, t) => sum + t.totalVentas,
                        0
                      ) / ventasPorTienda.length
                    )}
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} sm={6} md={3}>
                <Box className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200">
                  <Typography
                    variant="caption"
                    className="text-gray-700 font-medium"
                  >
                  ...
                  >
                    {ventasPorTienda[0]?.tiendaNombre || "N/A"}
                  </Typography>
                  <Typography variant="caption" className="text-purple-600">
                    {formatCurrency(ventasPorTienda[0]?.totalVentas || 0)}
                  </Typography>
                </Box>
              </Grid>
              <Grid item xs={12} sm={6} md={3}>
                <Box className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg border border-orange-200">
                  <Typography
                    variant="caption"
                    className="text-gray-700 font-medium"
                  >
                  ...
                  <Typography
                    variant="h5"
                    className="font-bold text-orange-700 mt-1"
                  >
                    {ventasPorTienda.length}
                  </Typography>
                </Box>
